      ...
      <div className="glass-card">
        ...
        {paymentMethod === 'online' && (
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              {[
                { id: 'all', name: 'Auto / Default', icon: 'ΓÜí' },
                { id: 'gpay', name: 'Google Pay', icon: '≡ƒîÉ' },
                { id: 'phonepe', name: 'PhonePe', icon: '≡ƒƒú' },
                { id: 'paytm', name: 'Paytm', icon: '≡ƒö╡' },
                { id: 'bhim', name: 'BHIM', icon: '≡ƒç«≡ƒç│' },
                { id: 'cred', name: 'CRED', icon: '≡ƒÆ│' }
              ].map(app => (
                <button
                  key={app.id}
                  type="button"
          ...
          <div className="modal-content" style={{ textAlign: 'center', maxWidth: 360 }}>
            ...
            {isScanningQr ? (
              ...
              <div style={{ fontSize: 13, color: 'var(--safe-light)', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                ...
                <span>Extracted: starbucks.coffee@icici (Γé╣450)</span>
              </div>
            )}
          </div>
        </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 18, fontWeight: 900, color: 'var(--safe-light)' }} className="mono">
                  Γé╣{completedTxnReceipt.amount.toLocaleString('en-IN')}
                </span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
